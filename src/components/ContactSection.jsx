...
const ContactSection = () => {
  ...
  I’m open to INTERNSHIP And Fresher level opportunity, internships, or just a friendly tech chat over coffee ☕.
</p>

        </CardHeader>
        <CardContent className="mt-4 flex justify-center items-center p-4 w-full">
         <a href="mailto:anushkavishwakarma98980@gmail.com"><ParticleButton className={`py-6 px-6 cursor-pointer`}><i className="ri-mail-line text-xl"></i><span className='text-xl'>Contact me!</span></ParticleButton></a>
        </CardContent>
      </Card>
    </div>
    </div>
