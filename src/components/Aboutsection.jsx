    ...
    <div className="py-4">
      <Card className="bg-white dark:bg-black text-black dark:text-white rounded-2xl shadow-md p-6 mr-4 ml-4 md:ml-0 ">
        <CardHeader className="space-y-2 text-center">
          ...
          <CardTitle className="text-3xl font-bold">I’m Anushka Vishwakarma</CardTitle>
          <p className="text-muted-foreground text-sm">
            Full Stack Developer • MERN Stack • React.js • Node.js • Express • MongoDB
          </p>
        </CardHeader>
        ...
        <CardContent className="mt-4 space-y-4 text-[16px] leading-relaxed tracking-wide text-justify">
          ...
          <p>
            Currently, I’m expanding my skills into areas like TypeScript, Data Structure, and better architectural practices to write cleaner and more maintainable codebases.
          </p>
        </CardContent>
      </Card>
    </div>
                      ...
                      <CommandButton>Socket.Io</CommandButton>
                        <CommandButton><i className="ri-tailwind-css-fill mr-2"></i>Tailwind</CommandButton>
                          <CommandButton>Redux</CommandButton>
                            <CommandButton><i className="ri-figma-line mr-2"></i>RedisDB</CommandButton>
                             <CommandButton><i className="ri-vercel-line mr-2"></i>Vercel</CommandButton>
                              <CommandButton>Git</CommandButton>
                               <CommandButton>High Level Design</CommandButton>
                               <CommandButton>Javascript</CommandButton>
                               <CommandButton>HTML & CSS</CommandButton>
