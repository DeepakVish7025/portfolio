...
const ProfileCard = () => {
  ...
  <CardHeader className={`flex flex-col items-center`}>
    ...
    <TiltedCard
      ...
      captionText="Deepak Vishwakarma"
    ...
    />
    <CardTitle className={`text-2xl`}>Anushka Vishwakarma</CardTitle>
    <CardDescription>FullStack Developer || MERN Developer</CardDescription>
  ...
  <CardContent className="flex justify-center">
    <div className="flex flex-wrap gap-1 sm:gap-2 justify-center">
      ...
      <CommandButton className="text-xs sm:text-sm">RedisDB</CommandButton>
    </div>
...
<CardFooter className={`flex justify-center`}>
   ...
   >
     <Button className={`cursor-pointer`} variant="outline">
       <i className="ri-attachment-2 mr-2"></i>Resume
     </Button>
   </a>
</CardFooter>
</Card>
